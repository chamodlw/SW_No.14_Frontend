          ...
          >
            ...
            >
              <CardContent>
                ...
                <Typography variant="body1">
                  {selectedAppointment && (
                    <ul style={{ listStyleType: 'circle', padding: 0 }}>
                      ...
                      <li><strong>Blood Tests:</strong> <br />{Array.isArray(selectedAppointment?.selectTests) ? selectedAppointment?.selectTests.map(test => <ul key={test.testName}>{test.testName}</ul>) : 'No tests'}</li>
                ...
                <Typography>
                  <Button onClick={handlePreview} style={{ color: '#101754', backgroundColor: '#D9D9D9', border: '1px solid #101754', borderRadius: '5px', padding: '5px 10px', maxWidth: '150px' }}>
                    Preview
                  </Button>
                </Typography>
              </CardContent>
